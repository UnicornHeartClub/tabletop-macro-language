  ...
  return new Promise(async (resolve, reject) => {
    ...
    step.args.forEach((arg) => {
      if (typeof arg.Roll !== 'undefined') {
        ...
        } else if (typeof rollArg.RR !== 'undefined' && typeof rollArg.RR.Comparitive !== 'undefined') {
          const comparitive = rollArg.RR.Comparitive.op
          const value = getArgValue(rollArg.RR.Comparitive.value)
