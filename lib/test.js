...
test.beforeEach((t) => {
  ...
  const api = sinon.stub().returns({
    rolls: [ {'id':'5e5f9750-6e78-4108-8fcf-b74731e2d0a0','comment':null,'dice':[{'id':'60b2dfd5-2f05-4bb6-b2ee-0ef7435c0d33','child':null,'die':'D20','is_dropped':false,'is_rerolled':false,'is_successful':true,'max':20,'min':1,'sides':20,'timestamp':'2018-01-09T14:20:20.374915727Z','value':12}],'equation':'1d20','execution_time':0,'modifiers':[],'raw_value':12,'timestamp':'2018-01-09T14:20:20.374917631Z','value':12} ],
  })
